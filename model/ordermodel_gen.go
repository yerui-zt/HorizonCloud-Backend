...
type (
	orderModel interface {
		...
		FindOne(ctx context.Context, session sqlx.Session, id int64) (*Order, error)
...
func (m *defaultOrderModel) FindOne(ctx context.Context, session sqlx.Session, id int64) (*Order, error) {
