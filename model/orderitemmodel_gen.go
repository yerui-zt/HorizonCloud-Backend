...
type (
	orderItemModel interface {
		...
		FindOne(ctx context.Context, session sqlx.Session, id int64) (*OrderItem, error)
...
func (m *defaultOrderItemModel) FindOne(ctx context.Context, session sqlx.Session, id int64) (*OrderItem, error) {
