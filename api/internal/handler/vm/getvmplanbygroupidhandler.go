...
func GetVMPlanByGroupIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetVMPlanByGroupIdReq
		...
		l := vm.NewGetVMPlanByGroupIdLogic(r.Context(), svcCtx)
		resp, err := l.GetVMPlanByGroupId(&req)
