...
func GetSSHKeyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSSHKeyReq
		...
		l := sshkeys.NewGetSSHKeyLogic(r.Context(), svcCtx)
		resp, err := l.GetSSHKey(&req)
